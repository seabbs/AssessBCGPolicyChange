...
The code and data for the analysis contained in this paper can be found at: DOI:10.5281/zenodo.2583056
...
We found a 1.9% annual decrease in TB incidence rates best matched notification data. We estimate that `r  str_replace(vac_2004_1, "Q", "Quantiles (Q)") %>% str_replace(" - ", "-")` vaccines would have been required to prevent a single notification in 2004. If the scheme had ended in 2001, `r avg_annual_2001_1  %>% str_replace(" - ", "-")` additional annual notifications would have occurred compared to if the scheme had continued. If the scheme ended in 2016, `r avg_annual_1_2016  %>% str_replace(" - ", "-")` additional annual notifications would have occurred.
