...
Sutherland et al. incorrectly defined the total expected number of secondary notifications ($T$) as the initial generation size ($x$). To correct this we revised 1. to the following in our updated model, 

$$ x = (1-d)^z < 1 $$
This update meant that we could not estimate when secondary notifications occurred. We have therefore reported secondary notifications occurring in the same year as the primary notifications that caused them. Implementing the model required several additional assumptions not detailed in [@Sutherland1989] - see the supplementary information for details.
