...
**Words:** *Title:* 15 *Abstract:* 250 *Paper:* 2911
...
comparision_tab %>% 
  pretty_table(label = "model_validation", 
               caption = "Comparision of results results published by Sutherland et al. vs. our recreated model. This table shows the total notifications including primary and secondary effects from ending the BCG schools' scheme at various times in ethnic White adults aged 15-29 years old in England and Wales.",
               tab_fun = knitr::kable,
...
prepare_results_table(year_new = "Year Ending Scheme") %T>% 
  ...
  pretty_table(label = "annual_prevent_tab",
               caption = "The median number (with the 2.5% and 97.% quantiles) of additional annual notifications due to ending the BCG schools' scheme in selected years.",
               tab_fun = knitr::kable,
               cap_fun = pretty_suptabref)
```
