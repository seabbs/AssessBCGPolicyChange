...
*We discuss alternative approaches for assessing the impact in the final paragraph of the discussion but you are correct in saying that the rationale of this work was to assess the impact of updateingree an existing framework. We have clarified this by adding the following sentence to the introduction,*
...
*Unfortunately, our choice of "-" to seperate estimates the 2.5% and 97.5% quantile made understanding this paragraph difficult. We have moved to using "," as this more clearly identifies when estimates are negative. Thank you for picking this up.*
